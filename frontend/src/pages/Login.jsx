        ...
        <div className="w-full max-w-md transform transition-all duration-500 hover:scale-[1.02]">
          <div className="bg-gray-900/40 backdrop-blur-xl rounded-2xl shadow-2xl p-8 space-y-8 border border-gray-800/50 relative overflow-hidden group">
            ...
            <div className="relative">
              ...
              {error && (
                <div className="mt-4 bg-red-900/50 border border-red-800 text-red-200 px-4 py-3 rounded-lg backdrop-blur-sm transform transition-all duration-300 hover:scale-[1.02]">
                  {error}
                </div>
              )}
              ...
              <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                <div className="space-y-4">
                  <div className="relative group">
                    <label htmlFor="email" className="block text-sm font-medium text-gray-300 transition-colors duration-200 group-hover:text-indigo-400">
                      Email address
                    </label>
                  ...
                  <div className="relative group">
                    <label htmlFor="password" className="block text-sm font-medium text-gray-300 transition-colors duration-200 group-hover:text-indigo-400">
                      Password
                    </label>
                    <div className="mt-1 relative">
                      <input
                      ...
                      <button
                        type="button"
                        className="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-indigo-400 transition-colors duration-200"
